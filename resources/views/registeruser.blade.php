                        ...
                        <div class="card-body p-5">
                            ...
                            <form action="/registeruser" method="POST">
                                ...
                                <div class="form-group mt-3">
                                    <label for="register-username" class="form-label text-white">Username</label>
                                ...
                                <div class="text-center mt-4">
                                    <button type="submit"
                                        class="btn btn-primary w-100 fw-bold text-black">Register</button>
                                </div>
                            </form>

                            <div class="text-center mt-3">
                                <p class="mb-0">Sudah punya akun? <a href="/loginuser" class="text-white">Login di
                                        sini</a></p>
                            </div>
                        </div>
                    </div>
