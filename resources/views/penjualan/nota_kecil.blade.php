...
<body onload="window.print()">
    ...
    <table width="100%">
        @foreach ($detail as $item)
            <tr>
                ...
                <td class="text-right">{{ $item->jumlah }} x {{ format_uang($item->harga_jual) }}</td>
            </tr>
            <tr>
                <td colspan="2" class="text-right">{{ format_uang($item->jumlah * $item->harga_jual) }}</td>
            </tr>
        @endforeach
    </table>
    <p class="text-center">===================================</p>
    ...
    <script>
        ...
        document.cookie = "innerHeight=" + Math.ceil(height * 0.264583); // Konversi pixel ke mm
    </script>
</body>
